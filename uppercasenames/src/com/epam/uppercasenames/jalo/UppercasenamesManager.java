...
import com.epam.uppercasenames.constants.UppercasenamesConstants;



/**
 * This is the extension manager of the Uppercasenames extension.
 */
public class UppercasenamesManager extends GeneratedUppercasenamesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(UppercasenamesManager.class.getName());
	 ...
	 */
	public static UppercasenamesManager getInstance()
	{
		return (UppercasenamesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				UppercasenamesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UppercasenamesManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UppercasenamesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of UppercasenamesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of UppercasenamesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
