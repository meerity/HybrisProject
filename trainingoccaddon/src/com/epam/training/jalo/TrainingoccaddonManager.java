...
import com.epam.training.constants.TrainingoccaddonConstants;



/**
 * This is the extension manager of the trainingoccaddon extension.
 */
public class TrainingoccaddonManager extends GeneratedTrainingoccaddonManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(TrainingoccaddonManager.class.getName());
	 ...
	 */
	public TrainingoccaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingoccaddonManager called.");
		}
	}
	 ...
	 */
	public static TrainingoccaddonManager getInstance()
	{
		return (TrainingoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingoccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
