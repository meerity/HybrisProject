...
import com.epam.training.core.populator.HttpRequestCustomerDataPopulator;
...
public class UsersController extends BaseCommerceController
{
	...
	@ResponseStatus(HttpStatus.OK)
	@Operation(operationId = "replaceUserLogin", summary = "Changes customer's login name. It's deprecated, use POST method instead.", description = "Changes a customer's login name. Requires the customer's current password.")
	@ApiBaseSiteIdAndUserIdParam
	...
	@ResponseStatus(HttpStatus.OK)
	@Operation(operationId = "changeUserLoginId", summary = "Changes customer's login id.", description = "Changes a customer's login id. Requires the customer's current password.")
	@ApiBaseSiteIdAndUserIdParam
	...
	@Operation(operationId = "changeUserPassword", summary = "Updates the password of a customer. ")
	@ApiBaseSiteIdAndUserIdParam
	...
	@Operation(operationId = "replaceUserPassword",summary = "Updates the password of a customer. It's deprecated, use POST method instead.")
	@ApiBaseSiteIdAndUserIdParam
