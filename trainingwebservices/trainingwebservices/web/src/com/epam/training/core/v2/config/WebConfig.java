 ...
 */
package com.epam.training.core.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.epam.training.core.request.mapping.handler.CommerceHandlerMapping;
...
public class WebConfig extends DelegatingWebMvcConfiguration
{
	...
	@Value("${trainingwebservices.core.v2.config.webconfig.MultipartResolver.maxUploadSize}")
