...
public class TestSetupUtils
{
	...
	private static void setupCommerce(final BiConsumer<TrainingwebservicesTestSetup, SystemSetupContext> triggerEqualsValidator)
	{
		final TrainingwebservicesTestSetup setup = getCommerceWebServicesTestSetup();
	...
	private static TrainingwebservicesTestSetup getCommerceWebServicesTestSetup()
	{
		return Registry.getApplicationContext().getBean("yCommerceWebServicesTestSetup", TrainingwebservicesTestSetup.class);
	}
	...
	private static SystemSetupContext createSystemSetupContext()
	{
		...
		{ "Go" });
		params.put("trainingwebservicestest_sample", new String[]
		{ "true" });
		...
		return new SystemSetupContext(params, Type.ALL, Process.ALL, "trainingwebservicestest");
	}
	...
	{
		if (!Config.getBoolean("trainingwebservicestest.embedded.server.enabled", true))
		{
	...
	public static void updateCaptchaCheckEnabled(final boolean enable)
	{
		...
		if (enable)
		{
			setupImpexService.importImpexFile("/trainingwebservicestest/import/captcha/captchaEnabled.impex", false);
		}
		else
		{
			setupImpexService.importImpexFile("/trainingwebservicestest/import/captcha/captchaDisabled.impex", false);
		}
	}
	...
	public static void updateSapInvoiceEnabled(final boolean enable)
	{
		...
		if (enable)
		{
			setupImpexService.importImpexFile("/trainingwebservicestest/import/invoice/invoiceEnabled.impex", false);
		}
		else
		{
			setupImpexService.importImpexFile("/trainingwebservicestest/import/invoice/invoiceDisabled.impex", false);
		}
	}
	...
	public static void updateCartRerievalDateCheckEnabled(final boolean enable)
	{
		...
		if (enable)
		{
			setupImpexService.importImpexFile("/trainingwebservicestest/import/cartretrievaldate/cartRetrievalDateEnabled.impex",
					false);
		}
		else
		{
			setupImpexService.importImpexFile("/trainingwebservicestest/import/cartretrievaldate/cartRetrievalDateDisabled.impex",
					false);
		}
	}
