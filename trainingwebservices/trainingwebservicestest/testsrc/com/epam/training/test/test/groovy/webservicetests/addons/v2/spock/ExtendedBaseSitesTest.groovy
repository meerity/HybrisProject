...
class ExtendedBaseSitesTest extends AbstractSpockFlowTest {
	...
	public void ignoreIf() {
		org.junit.Assume.assumeTrue(Config.getBoolean("trainingwebservicestest.enableAccTest", false))
	}
	...
	Those two fields have to be initialized for junit_cmssite table by file: /commercewebservices-module/trainingwebservicestest/resources/trainingwebservicestest/import/coredata/stores/wsTest/site.impex
	*/
