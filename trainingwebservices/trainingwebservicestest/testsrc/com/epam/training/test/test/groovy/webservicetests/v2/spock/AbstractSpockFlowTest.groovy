...
abstract class AbstractSpockFlowTest extends AbstractSpockTest {
	...
	protected boolean getToggleGenerateEntryGroupsInOrderAndQuotePopulator(){
		return Config.getBoolean(CommerceFacadesConstants.TOGGLE_GENERATE_ENTRY_GROUPS, false);
	}

	protected void setToggleGenerateEntryGroupsInOrderAndQuotePopulator(boolean toggle)
	{
		Config.setParameter(CommerceFacadesConstants.TOGGLE_GENERATE_ENTRY_GROUPS, String.valueOf(toggle));
	}
}
